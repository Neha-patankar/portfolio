    ...
    <>
      ...
      <footer className="bg-gray-900 text-white py-8">
        <div className="container mx-auto px-4 max-w-6xl">
          {/* Top footer with logo and quick links */}
            ...
            <div className="flex flex-wrap gap-6 justify-center">
              ...
              <div>
                ...
                <ul className="space-y-1">
                  ...
                  <li>
                    <a href="tel:+917909444055" className="text-gray-300 hover:text-blue-400 transition flex items-center">
                      <span className="mr-2">📞</span> Call : <span>7909444055</span>
                    </a>
                  </li>
                </ul>
              </div>
